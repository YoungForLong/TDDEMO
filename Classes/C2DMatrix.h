...
public:
  ...
  inline void TransformVec2s(std::vector<Vec2> &vPoints);

  //applys a transformation matrix to a point
  inline void TransformVec2s(Vec2 &vPoint);
...
//applies a 2D transformation matrix to a std::vector of Vec2s
inline void C2DMatrix::TransformVec2s(std::vector<Vec2> &vPoint)
{
...
//applies a 2D transformation matrix to a single Vec2
inline void C2DMatrix::TransformVec2s(Vec2 &vPoint)
{
